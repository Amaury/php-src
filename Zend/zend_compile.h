...
/* enhanced attributes visibility */
#define ZEND_ACC_WRITE_PUBLIC		0x10000000
#define ZEND_ACC_WRITE_PROTECTED	0x20000000
#define ZEND_ACC_WRITE_PRIVATE		0x40000000
#define ZEND_ACC_WRITE_CONST		0x80000000
#define ZEND_ACC_WRITE_PPPC_MASK	(ZEND_ACC_WRITE_PUBLIC | ZEND_ACC_WRITE_PROTECTED | ZEND_ACC_WRITE_PRIVATE | ZEND_ACC_WRITE_CONST)
#define ZEND_ACC_PPPPPPC_MASK		(ZEND_ACC_PPP_MASK | ZEND_ACC_WRITE_PPPC_MASK)
